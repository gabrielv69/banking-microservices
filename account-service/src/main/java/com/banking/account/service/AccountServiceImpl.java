...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public Flux<Account> getAllAccounts(Long customerId) {
        log.info(AccountMessages.LOG_ACCOUNT_GET_BY_CUSTOMER, customerId);
        if (customerId != null) {
            return accountRepository.findByCustomerId(customerId)
                    .doOnComplete(() ->
                            log.info(AccountMessages.LOG_ACCOUNT_GET_BY_CUSTOMER_ID_SUCCESS, customerId));
        } else {
            return accountRepository.findAll()
                    .doOnComplete(() ->
                            log.info(AccountMessages.LOG_ACCOUNT_GET_ALL_SUCCESS));
        }
    }
